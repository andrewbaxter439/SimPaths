...
//					maleMinAgeSick = age;
        ...
        */
        ...
        populationProjections = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "align_popProjections.xlsx", countryString, 3, 50);
        ...
        //Income
        coeffCovarianceIncomeI1a = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "reg_income.xlsx", countryString + "_I1a", 1, columnsIncomeI1a);
        coeffCovarianceIncomeI1b = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "reg_income.xlsx", countryString + "_I1b", 1, columnsIncomeI1b);
        ...
        coeffCovarianceIncomeI3c = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "reg_income.xlsx", countryString + "_I3c", 1, columnsIncomeI3c);
        coeffCovarianceIncomeI4a = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "reg_income.xlsx", countryString + "_I4a", 1, columnsIncomeI4a);
        ...
        coeffCovarianceIncomeI5b_amount = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "reg_income.xlsx", countryString + "_I5b_amount", 1, columnsIncomeI5b);
        coeffCovarianceIncomeI6a_selection = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "reg_income.xlsx", countryString + "_I6a_selection", 1, columnsIncomeI6a);
        coeffCovarianceIncomeI6b_amount = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "reg_income.xlsx", countryString + "_I6b_amount", 1, columnsIncomeI6b);
...
*/
    ...
    public static TreeMap<Integer, String> calculateEUROMODpolicySchedule(Country country) {
        ...
        MultiKeyCoefficientMap currentEUROMODpolicySchedule = ExcelAssistant.loadCoefficientMap(Parameters.INPUT_DIRECTORY + EUROMODpolicyScheduleFilename + ".xlsx", country.toString(), 1, 3);
    ...
    */
    ...
    public static void loadTimeSeriesFactorMaps(Country country) {
        ...
        priceMapSavingReturns = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "time_series_factor.xlsx", country.toString() + "_saving_returns", 1, 1);
        priceMapDebtCostLow = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "time_series_factor.xlsx", country.toString() + "_debt_cost_low", 1, 1);
        priceMapDebtCostHigh = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "time_series_factor.xlsx", country.toString() + "_debt_cost_hi", 1, 1);
        ...
        upratingIndexMapGDP = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "time_series_factor.xlsx", country.toString() + "_gdp", 1, 1);
        ...
        upratingIndexMapWageGrowth = ExcelAssistant.loadCoefficientMap(Parameters.getInputDirectory() + "time_series_factor.xlsx", country.toString() + "_wage_growth", 1, 1);
